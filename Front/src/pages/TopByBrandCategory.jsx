...
function TopByBrandCategory({ brand = 'Green Life', category = 'Dairy Alternatives', limit = 10 }) {
  ...
  useEffect(() => {
    setLoading(true);
    setError(null);
    fetch(`/products/top-by-brand-category?brand=${encodeURIComponent(brand)}&category=${encodeURIComponent(category)}&limit=${limit}`)
      .then(res => {
