...
function TopByCategory() {
  ...
  const [searchCategory, setSearchCategory] = useState('Bakery');
  ...
  useEffect(() => {
    setLoading(true);
    setError(null);
    fetch(`/products/top-by-category?category=${encodeURIComponent(searchCategory)}&limit=${searchLimit}`)
      .then(res => {
            ...
            <CardContent sx={{ p: { xs: 1, sm: 2 } }}>
              <Box display="flex" alignItems="center" gap={1} mb={0.5}>
                <Box flex={1} minWidth={0}>
                  ...
                  <Typography variant="body2" fontWeight={600} color="#5B5BFF" sx={{ fontSize: { xs: '0.9rem', sm: '1.05rem' }, wordBreak: 'break-word', lineHeight: 1.1 }}>{product.marque}</Typography>
